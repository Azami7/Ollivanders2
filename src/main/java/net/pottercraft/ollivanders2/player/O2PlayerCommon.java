...
public final class O2PlayerCommon {
	 ...
	 *
	 * @return the animagus form for this player - should always be the same since
	 *         it is based on a hash of their PID
	 */
	@NotNull
	...
	/**
	 * Checks what kind of wand a player holds in their primary hand. Returns a
	 * value based on the wand and its relation to the player.
	 * <p>
	 ...
	 *         <br>
	 *         1 - the wand is player's type and is allied to player OR the wand is
	 *         the elder wand and is not allied to player. <br>
	...
	/**
	 * Checks what kind of wand a player holds. Returns a value based on the wand
	 * and it's relation to the player.
	 * <p>
	 ...
	 * @return 2 - The wand is not player's type <br>
	 *         1 - The wand is player's type <br>
	 *         0.5 - The wand is the elder wand <br>
	...
	private double doWandCheck(@NotNull Player player, @NotNull ItemStack itemStack) {
		...
		if (!(Ollivanders2API.getItems().getWands().isDestinedWand(o2p, itemStack))) {
			...
			common.printDebugMessage("O2PlayerCommon.doWandCheck: player holds a wand which is not their destined wand",
					null, null, false);
			return 2;
		}
