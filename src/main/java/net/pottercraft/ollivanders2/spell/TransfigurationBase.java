...
/**
 * The base class for all transfiguration spells that change blocks and
 * entities.
 */
public abstract class TransfigurationBase extends O2Spell {
	...
	/**
	 * If the target is not transfigured, attempt to transfigure it. If it is
	 * transfigured and this is not a permanent spell, age the spell one tick.
	 */
	@Override
	protected void doCheckEffect() {
		// if a target has not transfigured, look for one to transfigure otherwise move
		// the projectile on
		if (!isTransfigured()) {
