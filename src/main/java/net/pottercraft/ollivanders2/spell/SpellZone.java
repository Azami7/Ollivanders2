...
public class SpellZone {
	 ...
	 * @param area       the area bounds for this zone if a cuboid, this should be
	 *                   opposite corners
	 * @param allowed    a list of allowed spells, if set, this will take precedence
	 *                   over a disallow list
	 * @param disallowed a list of disallowed spells
	 */
	SpellZone(@NotNull String name, @NotNull String world, @NotNull SpellZoneType type, int[] area,
			@NotNull ArrayList<O2SpellType> allowed, @NotNull ArrayList<O2SpellType> disallowed) {
		zoneName = name;
		zoneType = type;
		zoneWorldName = world;
