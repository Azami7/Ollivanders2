...
/**
 * Glacius will cause a great cold to descend in a radius from it's impact point
 * which freezes blocks. The radius and duration of the freeze depend on your
 * experience.
 * <p>
