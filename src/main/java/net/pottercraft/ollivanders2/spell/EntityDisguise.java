 ...
 * <p>
 * Reference:
 * https://www.spigotmc.org/wiki/lib-s-disguises-disguising-the-entity/
 */
public abstract class EntityDisguise extends EntityTransfiguration {
	 ...
	 * <p>
	 * Entity can transfigure if: 1. The entity is not already the target type 2. It
	 * is not in the blocked list 3. It is in the allowed list, if the allowed list
	 * exists
	 *
