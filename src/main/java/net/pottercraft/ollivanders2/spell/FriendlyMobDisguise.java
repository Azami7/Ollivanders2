...
public abstract class FriendlyMobDisguise extends EntityDisguise {
	...
	/**
	 * Large size friendly mobs. Ender Dragon is explicitly excluded as it is too
	 * big/strong to target.
	 * <p>
	 * Reference: https://minecraft.fandom.com/wiki/Mob
	 */
	...
	/**
	 * Populate the entity allowed list for this spell based on the caster's skill
	 * and level.
	 * <p>
