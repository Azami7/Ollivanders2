...
public abstract class StationarySpell extends O2Spell {
	...
	/**
	 * Is the location for this stationary spell centered at the caster or a
	 * projectile target
	 */
	 ...
	 */
	int maxDuration = Ollivanders2Common.ticksPerMinute * 30; // 30 minutes, only applies to non-permanent stationary
																// spells.
	...
	/**
	 * Create the stationary spell with duration and radius based on the caster's
	 * skill.
	 */
	@Override
	protected void doCheckEffect() {
		...
		// set duration to be base time plus a modifier seconds per experience level for
		// this spell
	...
	/**
	 * Create the stationary spell. Has to be overridden by child spells to have
	 * effect.
	 *
