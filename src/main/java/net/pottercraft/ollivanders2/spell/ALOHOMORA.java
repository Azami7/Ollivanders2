...
public final class ALOHOMORA extends O2Spell {
	...
	protected void doCheckEffect() {
		...
		// check all the stationary spells in the location of the projectile for a
		// Colloportus
		List<O2StationarySpell> inside = new ArrayList<>();
		List<O2StationarySpell> stationarySpellsAtLocation = Ollivanders2API.getStationarySpells()
