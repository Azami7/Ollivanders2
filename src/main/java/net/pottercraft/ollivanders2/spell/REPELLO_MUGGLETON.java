...
/**
 * Repello Muggleton will hide any blocks and players in it's radius from those
 * outside of it.
 * <p>
...
public final class REPELLO_MUGGLETON extends StationarySpell {
	...
	protected O2StationarySpell createStationarySpell() {
		return new net.pottercraft.ollivanders2.stationaryspell.REPELLO_MUGGLETON(p, player.getUniqueId(), location,
				radius, duration);
	}
}