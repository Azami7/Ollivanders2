...
/**
 * Makes a spell projectile that creates a shield that hurts any entities within
 * 0.5 meters of the spell wall.
 * <p>
...
public final class PROTEGO_MAXIMA extends StationarySpell {
	...
	protected O2StationarySpell createStationarySpell() {
		return new net.pottercraft.ollivanders2.stationaryspell.PROTEGO_MAXIMA(p, player.getUniqueId(), location,
