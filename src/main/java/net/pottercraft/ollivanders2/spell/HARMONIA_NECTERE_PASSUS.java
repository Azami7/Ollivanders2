 ...
 * <p>
 * Reference: https://harrypotter.fandom.com/wiki/Harmonia_Nectere_Passus
 */
public final class HARMONIA_NECTERE_PASSUS extends O2Spell {
	...
	protected void doCheckEffect() {
		...
		if (Ollivanders2Common.locationEquals(toLoc, fromLoc)) {
			...
			player.sendMessage(
					Ollivanders2.chatColor + "To and from locations on vanishing cabinet signs are the same.");
			return;
		}
		...
		net.pottercraft.ollivanders2.stationaryspell.HARMONIA_NECTERE_PASSUS harmoniaFrom = new net.pottercraft.ollivanders2.stationaryspell.HARMONIA_NECTERE_PASSUS(
				p, player.getUniqueId(), fromLoc, toLoc);
		net.pottercraft.ollivanders2.stationaryspell.HARMONIA_NECTERE_PASSUS harmoniaTo = new net.pottercraft.ollivanders2.stationaryspell.HARMONIA_NECTERE_PASSUS(
				p, player.getUniqueId(), toLoc, fromLoc);
