...
/**
 * Full Body-Bind Curse - Used to temporarily bind the victim's body in a
...
public class PETRIFICUS_TOTALUS extends O2Spell {
	...
	protected void doCheckEffect() {
		...
		for (Player target : getNearbyPlayers(defaultRadius)) {
			...
			IMMOBILIZE immobilize = new IMMOBILIZE(p, durationInSeconds * Ollivanders2Common.ticksPerSecond,
					target.getUniqueId());
