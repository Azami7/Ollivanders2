...
public abstract class PlayerDisguise extends EntityDisguise {
	...
	/**
	 * Calculate the success rate for this spell. This has to be run from the spell
	 * itself after setting usesModifier since it is based on specific spell usage.
	 */
