...
/**
 * Creates a muffliato stationary spell object. Only players within that object
 * can hear other players within it. Time duration depends on spell's level.
 * <p>
...
public final class MUFFLIATO extends StationarySpell {
	...
	protected O2StationarySpell createStationarySpell() {
		return new net.pottercraft.ollivanders2.stationaryspell.MUFFLIATO(p, player.getUniqueId(), location, radius,
				duration);
	}
}