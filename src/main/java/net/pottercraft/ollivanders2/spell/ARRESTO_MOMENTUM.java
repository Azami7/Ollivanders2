...
public final class ARRESTO_MOMENTUM extends O2Spell {
	...
	/**
	 * Checks for entities or items in a radius around the projectile and slows
	 * their velocity, if found
	 */
	@Override
	protected void doCheckEffect() {
		...
		// if the spell has hit a solid block, the projectile is dead and wont go
