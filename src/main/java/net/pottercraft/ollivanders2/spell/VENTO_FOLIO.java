 ...
 * <p>
 * Tom Riddle is the first wizard known to achieve unassisted flying and only
 * one other wizard learned it from him, Severus Snape. Unassisted flying is
 * against magical law.
 * <p>
...
public final class VENTO_FOLIO extends O2Spell {
	...
	/**
	 * Override checkEffect since this spell should not projectile. Add flying
	 * effect to caster.
	 */
	@Override
