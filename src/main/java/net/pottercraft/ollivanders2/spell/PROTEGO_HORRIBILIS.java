...
/**
 * Protego horribilis stops spells entering the protected area, except the
 * Killing Curse (which is too strong).
 * <p>
...
public final class PROTEGO_HORRIBILIS extends StationarySpell {
	...
	protected O2StationarySpell createStationarySpell() {
		return new net.pottercraft.ollivanders2.stationaryspell.PROTEGO_HORRIBILIS(p, player.getUniqueId(), location,
				radius, duration);
	}
}