...
/**
 * If a coreless wand is near enough a core material, makes a wand of the wand
 * wood type and core type. Itemstack amount is 1 regardless of how many items
 * were in either starting stack.
 * <p>
 * {@link FRANGE_LIGNEA}
 */
public final class LIGATIS_COR extends O2Spell {
	...
	protected void doCheckEffect() {
		...
		if ((baseWand == null) || Ollivanders2API.getItems().getWands().isWand(baseWand.getItemStack()))
			return;
	...
	private void createAndDropWand(@NotNull Item baseWand) {
		...
		Item coreItem = EntityCommon.getNearbyItemByMaterialList(baseWand.getLocation(),
				O2WandCoreType.getAllCoresByMaterial(), 2.0);
		if (coreItem != null) {
