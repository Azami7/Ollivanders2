...
/**
 * Amato Animo Animato Animagus is an incantation used in the process of
 * becoming an Animagus. The spell alone is not enough to change a player in to
 * an Animagus. The spell has to be recited either at sunrise or sunset and the
 * player must drink the Animagus potion after saying the incantation. The
 * potion must be consumed during a lightning storm. Once the player has
 * successfully become an Animagus it will require considerable practice before
 * they can consistently take the form.
 *
 * @since 2.2.6
 * @author Azami7
 */
public class AMATO_ANIMO_ANIMATO_ANIMAGUS extends O2Spell {
	 ...
	 */
	public AMATO_ANIMO_ANIMATO_ANIMAGUS(@NotNull Ollivanders2 plugin, @NotNull Player player,
	...
	public void checkEffect() {
		...
		if (o2p.isAnimagus()) {
			// If the player is already an animagus, the incantation changes them to and
			// from their animal form.
	...
	/**
	 * If the player is not an animagus, saying the incantation at the correct time
	 * of day is the first step to becoming one. Once said, the player must drink
	 * the Animagus potion within 15 seconds.
	 */
	...
	/**
	 * If the player is an animagus, saying the incantation will toggle them to and
	 * from their animal form. Changing to animal form takes practice to do
	 * consistently. Players can always return to their human form once transformed.
	 *
