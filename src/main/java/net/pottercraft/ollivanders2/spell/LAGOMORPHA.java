...
/**
 * Transfigures an entity into a rabbit. This is a split oof the Lapifor spell
 * since we need to handle items and mobs differently.
 * <p>
...
public final class LAGOMORPHA extends FriendlyMobDisguise {
	...
	public LAGOMORPHA(@NotNull Ollivanders2 plugin, @NotNull Player player, @NotNull Double rightWand) {
		...
		// this needs to be done at the end because it needs to consider the
		// usesModifier
