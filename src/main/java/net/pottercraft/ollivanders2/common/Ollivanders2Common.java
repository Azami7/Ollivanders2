...
public class Ollivanders2Common {
	...
	/**
	 * Spells that use libsDisguises. Used to disable these spells when we detect
	 * libsDisguises is not installed on the server.
	 */
	...
	/**
	 * Potions that use libsDisguises. Used to disable these potions when we detect
	 * libsDisguises is not installed on the server.
	 */
	...
	/**
	 * All chest materials. Newer versions of minecraft have made checks to
	 * determine if a block is a chest a lot harder than the olden days.
	 */
	...
	/**
	 * All wall sign materials. Newer versions of minecraft have made checks to
	 * determine if a block is a wall sign a lot harder than the olden days.
	 */
	...
	/**
	 * All standing sign materials. Newer versions of minecraft have made checks to
	 * determine if a block is a sign a lot harder than the olden days.
	 */
	...
	/**
	 * All sign materials. Newer versions of minecraft have made checks to determine
	 * if a block is a sign a lot harder than the olden days.
	 */
	...
	/**
	 * All door materials. Newer versions of minecraft have made checks to determine
	 * if a block is a door a lot harder than the olden days.
	 */
	...
	/**
	 * All trapdoor materials. Newer versions of minecraft have made checks to
	 * determine if a block is a trapdoor a lot harder than the olden days.
	 */
	 ...
	 * @return string such that it is the lowercase version of the spell minus
	 *         underscores
	 */
	@NotNull
	...
	/**
	 * Converts a string to have it's first letter of each word be in upper case,
	...
	static public boolean isNaturalLog(@NotNull Block block) {
		...
		return (material == Material.OAK_LOG || material == Material.BIRCH_LOG || material == Material.ACACIA_LOG
				|| material == Material.DARK_OAK_LOG || material == Material.JUNGLE_LOG
				|| material == Material.SPRUCE_LOG);
	}

	/**
	 * Makes a particle effect at all points along the radius of spell and at spell
	 * loc.
	 *
	 * @param location  the location for the center of the flair
	 * @param radius    the radius of the flair
	 * @param intensity intensity of the flair. If greater than 10, is reduced to
	 *                  10.
	 */
	 ...
	 */
	static public void sendTitleMessage(@NotNull String title, @Nullable String subtitle,
	 ...
	 * @param isWarning        true if this should be at WARNING level, false if it
	 *                         should be INFO level
	 */
	public void printDebugMessage(@NotNull String message, @Nullable Exception exception,
			@Nullable RuntimeException runtimeException, boolean isWarning) {
	 ...
	 *                         should be INFO level
	 */
	public void printLogMessage(@NotNull String message, @Nullable Exception exception,
			@Nullable RuntimeException runtimeException, boolean isWarning) {
		if (isWarning) {
	...
	static public boolean locationEquals(@NotNull Location loc1, @NotNull Location loc2) {
		return (loc1.getWorld() == loc2.getWorld() && loc1.getX() == loc2.getX() && loc1.getY() == loc2.getY()
				&& loc1.getZ() == loc2.getZ());
	}
}
