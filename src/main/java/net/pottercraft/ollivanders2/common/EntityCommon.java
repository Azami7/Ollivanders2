...
public class EntityCommon {
	...
	/**
	 * Reasons an entity may get damaged which are caused by an attack (rather than
	 * falling, etc)
	 */
	...
	/**
	 * The magic level for every potion effect type, primarily for use with Finite
	 * Incantatum
	 * <p>
	 ...
	 */
	@NotNull
	static public List<Entity> getNearbyEntitiesByType(@NotNull Location location, double radius,
	 ...
	 */
	@Nullable
	static public Item getNearbyItemByMaterialList(@NotNull Location location, @NotNull ArrayList<Material> materials,
			double radius) {
		List<Item> items = getItems(location, radius);
