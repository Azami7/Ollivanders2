...
/**
 * Class for managing all prophecies. A prophecy is made via divination and
 * concerns future effects on a player.
 *
 * @author Azami7
 * @since 2.2.9
 */
public class O2Prophecies {
	...
	private O2Prophecy deserializeProphecy(@NotNull Map<String, String> prophecyData) {
		...
		if (effectType != null && prophecyMessage != null && targetID != null && prophetID != null && time != null
				&& duration != null && accuracy != null) {
