 ...
 * on the server, all calls will short circuit to allow actions.
 *
 * @since 2.2.5
...
public class Ollivanders2WorldGuard {
	...
	public ApplicableRegionSet getWGRegionSet(@NotNull Location location) {
		...
		com.sk89q.worldedit.util.Location weLocation = new com.sk89q.worldedit.util.Location(weWorld, location.getX(),
	...
	/**
	 * If WorldGuard is enabled, determine if player is allowed a specific
	 * permission. This is done so that Ollivanders2 actions do not complete
	 * partially, such as mob transfiguration spells, and then cannot complete
	 * because WorldGuard is enabled.
	 *
	 * @param player   the player to check for
	 * @param location the location to check (since it may not be where the player
	 *                 is)
	 * @return true if the player has this permission at this location, false
	 *         otherwise
	 */
	...
	/**
	 * If WorldGuard is enabled, determine if the player has build permissions. This
	 * is done so that Ollivanders2 actions do not complete partially, such as
	 * object transformation spells, and then cannot complete because WorldGuard is
	 * enabled.
	 *
	 ...
	 * @param location the location to check (since it may not be where the player
	 *                 is)
	 * @return true if the player has permissions to build at their location, false
	 *         otherwise
	 */
