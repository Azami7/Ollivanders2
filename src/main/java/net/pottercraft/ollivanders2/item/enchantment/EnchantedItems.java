 ...
 * <p>
 * Enchantments are used to give items magical properties like broom flight,
 * port keys, and cursed items.
 * <p>
...
public class EnchantedItems implements Listener {
	 ...
	 * @param args      optional arguments for this enchantment
	 */
	public void addEnchantedItem(@NotNull ItemStack itemStack, @NotNull ItemEnchantmentType eType, int magnitude,
			@NotNull String eid, @NotNull String args) {
		...
		common.printDebugMessage("Added enchanted item " + itemMeta.getDisplayName() + " of type " + eType.getName(),
				null, null, false);
	}
	...
	/**
	 * Get the enchantment object for this enchanted item - this will either get the
	 * existing or create one
	 *
	 * @param itemStack the enchanted item
	...
	public Enchantment createEnchantment(@NotNull String eType, @NotNull Integer magnitude, @Nullable String args) {
		...
		try {
			enchantment = (Enchantment) enchantmentClass
					.getConstructor(Ollivanders2.class, int.class, String.class, String.class)
					.newInstance(p, magnitude, args, enchantmentType.getLore());
		} catch (Exception e) {
