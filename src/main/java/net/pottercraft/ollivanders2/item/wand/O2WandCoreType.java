...
public enum O2WandCoreType {
	SPIDER_EYE(Material.SPIDER_EYE, "Spider Eye"), BONE(Material.BONE, "Bone"),
	ROTTEN_FLESH(Material.ROTTEN_FLESH, "Rotten Flesh"), GUNPOWDER(Material.GUNPOWDER, "Gunpowder");
