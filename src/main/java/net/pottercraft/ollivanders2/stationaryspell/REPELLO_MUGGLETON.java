...
/**
 * Hides all players within its area. The code to hide players is located in
 * OllivandersSchedule.invisPlayer()
 * <p>
...
public class REPELLO_MUGGLETON extends ShieldSpell {
	 ...
	 */
	public REPELLO_MUGGLETON(@NotNull Ollivanders2 plugin, @NotNull UUID pid, @NotNull Location location, int radius,
			int duration) {
		super(plugin);
	...
	/**
	 * Do not allow targeting if the target is inside the radius and the targeter is
	 * not
	 *
