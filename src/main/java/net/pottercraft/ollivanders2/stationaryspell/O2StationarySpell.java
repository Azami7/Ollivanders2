...
public abstract class O2StationarySpell implements Serializable {
	...
	/**
	 * Is this spell currently active. Duration still counts down when spell is
	 * inactive.
	 */
	boolean active = true;
	...
	/**
	 * Set the duration remaining for this stationary spell. This can be lower than
	 * the min duration since spells may reduce the time remaining and loading
	 * stationary spells from the save file on restart should set them to however
	 * much time was left
	 *
	...
	/**
	 * Set whether this spell should be active or not. Duration counts down
	...
	/**
	 * Get living entities whose eye location is within the radius. We use eye
	 * radius to handle entities bigger than 1 block.
	 *
	...
	/**
	 * Get a copy of the location for this stationary spell. A copy is returned
	 * because a stationary spell location cannot be changed.
	 *
	...
	/**
	 * This is the stationary spell's effect. age() must be called in this if you
	 * want the spell to age and die eventually.
	 */
