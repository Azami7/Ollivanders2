...
public enum O2StationarySpellType {
	ALIQUAM_FLOO(ALIQUAM_FLOO.class, MagicLevel.EXPERT), COLLOPORTUS(COLLOPORTUS.class, MagicLevel.EXPERT), // colloportus
																											// can only
																											// be undone
																											// with
																											// alohomora
	...
	HORCRUX(HORCRUX.class, MagicLevel.EXPERT), MOLLIARE(MOLLIARE.class, MagicLevel.OWL),
	MUFFLIATO(MUFFLIATO.class, MagicLevel.NEWT), NULLUM_APPAREBIT(NULLUM_APPAREBIT.class, MagicLevel.EXPERT),
	NULLUM_EVANESCUNT(NULLUM_EVANESCUNT.class, MagicLevel.EXPERT), PROTEGO(PROTEGO.class, MagicLevel.OWL),
	PROTEGO_HORRIBILIS(PROTEGO_HORRIBILIS.class, MagicLevel.EXPERT),
	PROTEGO_MAXIMA(PROTEGO_MAXIMA.class, MagicLevel.EXPERT), PROTEGO_TOTALUM(PROTEGO_TOTALUM.class, MagicLevel.EXPERT),
	 ...
	 * @return true if the player is within the radius of a stationary spell of this
