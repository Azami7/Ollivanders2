...
public abstract class PotionEffectAntidoteSuper extends O2Effect {
	...
	/**
	 * strength of this antidote - strength of 1 will cancel the potion effect
	 * entirely, 0.5 reduced by half time, 0.25 reduced by quarter time, etc.
	 */
			...
			if (targetEffect != null) {
				...
				if (strength < 1) {
					...
					target.addPotionEffect(
							new PotionEffect(potionEffectType, newDuration, targetEffect.getAmplifier()));
				}
			}
		}
