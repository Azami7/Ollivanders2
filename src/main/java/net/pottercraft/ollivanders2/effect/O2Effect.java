 ...
 * <p>
 * O2EffectType cannot permanently change the O2Player but some effects may
 * remain until a specific removal action/effect is taken.
 */
public abstract class O2Effect {
	...
	/**
	 * The number of game ticks this effect lasts. 24000 ticks is one MC day and
	 * should be ~20 real minutes.
	 */
	public int duration;
	...
	/**
	 * Whether this effect is permanent. Permanent effects do not age and can only
	 * be removed by explicitly killing them.
	 */
	...
	/**
	 * The output to be shown for information spells like Informous, if this effect
	 * can be detected in this way. This string is the predicate of a sentence that
	 * starts with the player's name and should not include ending punctuation.
	 * Example: "feels unnaturally tired"
	 */
	protected String informousText;

	/**
	 * The output to be shown for mind-reading spells like Legilimens, if this
	 * effect can be detected in this way. This string is the predicate of a
	 * sentence that starts with the player's name and should not include ending
	 * punctuation. Example: "feels aggressive"
	 */
	protected String legilimensText;

	/**
	 * The output to be shown for prophecies that use this effect. This should be in
	 * future tense.
	 */
	...
	/**
	 * Constructor. If you change this method signature, be sure to update all
	 * reflection code that uses it.
	 *
	...
	/**
	 * This is the effect's action. age() must be called in this if you want the
	 * effect to age and die eventually.
	 */
