...
/**
 * Causes a player to chat nonsense. Any Babbling effects must also be added to
 * onPlayerChat in Ollivanders2Listener.
 *
 * @since 2.2.7
 * @author Azami7
 */
public class BABBLING extends O2Effect {
	...
	void doOnAsyncPlayerChatEvent(@NotNull AsyncPlayerChatEvent event) {
		...
		common.printDebugMessage("Changed " + event.getPlayer().getDisplayName() + "'s chat from \"" + message
				+ "\" to \"" + newMessage + "\"", null, null, false);
	}
}