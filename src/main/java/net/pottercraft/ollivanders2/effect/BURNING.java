...
public class BURNING extends O2Effect {
	...
	/**
	 * Age the effect if not permanent and damage the player if this is the right
	 * tick
	 */
	@Override
	...
	/**
	 * Override default set permanent to make sure it doesnt get called and alter
	 * the duration since this is already a permanent effect.
	 *
