...
/**
 * Turns player into a werewolf during the full moon. Doesn't go away until
 * death (if deathExpLoss is set to true).
 *
 * @author azami7
 * @since 2.2.8
 */
public class LYCANTHROPY extends ShapeShiftSuper {
	...
	/**
	 * Add additional effects of lycanthropy such as aggression and speaking like a
	 * wolf
	 */
	...
	/**
	 * Override setPermanent so that no code can inadvertently make lycanthropy
	 * effect age.
	 *
