...
public enum O2HouseType {
	GRYFFINDOR("Gryffindor", O2Color.DARK_RED), HUFFLEPUFF("Hufflepuff", O2Color.GOLD),
	RAVENCLAW("Ravenclaw", O2Color.BLUE), SLYTHERIN("Slytherin", O2Color.DARK_GREEN);
	...
	/**
	 * Set the display name for this house. Should only be done from within the
	 * House package.
	 *
	...
	/**
	 * Set the color for this house. Should only be done from within the House
	 * package. No change is made if the string is not a valid ChatColor value.
	 *
	...
	/**
	 * Set the score for this house. Should only be done from within the House
	 * package.
	 *
