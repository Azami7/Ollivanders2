...
/**
 * The Forgetfulness Potion is a potion which causes a degree of memory loss in
 * the drinker.
 *
...
public final class FORGETFULLNESS_POTION extends O2Potion {
	...
	public FORGETFULLNESS_POTION(@NotNull Ollivanders2 plugin) {
		...
		flavorText.add(
				"Hermione Granger: \"What are the three most crucial ingredients in a Forgetfulness Potion?\"\nRon Weasley: \"I forgot.\"");
	...
	public void drink(@NotNull Player player) {
		...
		common.printDebugMessage("Forgetfullness Potion: " + player.getDisplayName() + " lost " + memLoss
				+ " experience  with " + lostSpell, null, null, false);
