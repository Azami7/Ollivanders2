...
/**
 * The Antidote for Common Poisons is a potion which counteracts ordinary
 * poisons, such as creature bites and stings.
 *
...
public final class COMMON_ANTIDOTE_POTION extends O2Potion {
	...
	public void drink(@NotNull Player player) {
		if (player.hasPotionEffect(PotionEffectType.POISON)) {
			...
			player.sendMessage(
					Ollivanders2.chatColor + "A cool feeling flows through your body as the poison is removed.");
		} else {
			player.sendMessage(
					Ollivanders2.chatColor + "You smell a faint odor that reminds you of winter, then it is gone.");
		}
	}
}