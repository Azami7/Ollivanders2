...
/**
 * The Cure for Boils (also known as simply Boil Cure) is a potion which cures
 * boils, even those produced by the Pimple Jinx.
 *
 * @author Azami7
 * @since 2.2.8
 */
public class CURE_FOR_BOILS extends O2Potion {
	...
	public CURE_FOR_BOILS(@NotNull Ollivanders2 plugin) {
		...
		flavorText.add(
				"\"Being an effective remedie against pustules, hives, boils and many other scrofulous conditions. This is a robust potion of powerful character. Care should be taken when brewing. Prepared incorrectly this potion has been known to cause boils, rather than cure them...\" -Zygmunt Budge");
