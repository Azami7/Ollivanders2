...
/**
 * The Wiggenweld Potion is a healing potion with the power to awaken a person
 * from a magically-induced sleep, which gives it the ability to reverse the
 * effects of potions like the Sleeping Draught and the Draught of Living Death.
 *
 * @author Azami7
 * @since 2.2.8
 */
public class WIGGENWELD_POTION extends O2SplashPotion {
	...
	public WIGGENWELD_POTION(@NotNull Ollivanders2 plugin) {
		...
		flavorText.add(
				"\"Today you will learn to brew the Wiggenweld Potion. It is a powerful healing potion that can be used to heal injuries, or reverse the effects of a Sleeping Draught.\" -Severus Snape");
