...
public enum O2PotionType {
	ANIMAGUS_POTION(ANIMAGUS_POTION.class, MagicLevel.NEWT), BABBLING_BEVERAGE(BABBLING_BEVERAGE.class, MagicLevel.OWL),
	...
	HERBICIDE_POTION(HERBICIDE_POTION.class, MagicLevel.BEGINNER), MEMORY_POTION(MEMORY_POTION.class, MagicLevel.NEWT),
	REGENERATION_POTION(REGENERATION_POTION.class, MagicLevel.NEWT),
	SLEEPING_DRAUGHT(SLEEPING_DRAUGHT.class, MagicLevel.BEGINNER),
	WIDEYE_POTION(WIDEYE_POTION.class, MagicLevel.BEGINNER), WIGGENWELD_POTION(WIGGENWELD_POTION.class, MagicLevel.OWL),
	...
	/**
	 * Get a O2PotionType enum from a string. This should be used as the opposite of
