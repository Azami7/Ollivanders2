...
/**
 * The Wit-Sharpening Potion is a potion which allows the drinker to think more
 * clearly. Due to this, it acts a a counteragent to the Confundus Charm.
 *
 * @author Azami7
 */
public final class WIT_SHARPENING_POTION extends O2Potion {
	...
	public WIT_SHARPENING_POTION(@NotNull Ollivanders2 plugin) {
		...
		flavorText.add(
				"\"Some of you will benefit from today's assignment: Wit-Sharpening Potion. Perhaps you should begin immediately.\" -Severus Snape");
