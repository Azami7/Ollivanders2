...
/**
 * The regeneration potion restores a player's experience after death if
 * deathExpLoss is enabled.
 *
 * @author Azami7
 */
public final class REGENERATION_POTION extends O2Potion {
	...
	public REGENERATION_POTION(@NotNull Ollivanders2 plugin) {
		...
		flavorText.add(
				"\"Bone of the father, unknowingly given, you will renew your son! Flesh of the servant, willingly sacrificed, you will revive your master. Blood of the enemy, forcibly taken, you will resurrect your foe.\" -Peter Pettigrew");
