 ...
 *
 * Book limits: Title - 32 characters Pages - 50 Lines per page - 14 Characters
 * per page - 256, newlines count as 2 characters Characters per line - 16-18
 * depending on the exact characters
 *
 * @since 2.2.4
 * @author Azami7
 */
public abstract class O2Book {
	...
	/**
	 * No more than 11 spells + potions in a book or they won't fit on the table of
	 * contents.
	 */
	...
	public O2Book(@NotNull Ollivanders2 plugin) {
		...
		// create the book on first request to ensure texts, etc are loaded before
		// trying to create it
		bookItem = null;
	 ...
	 *
	 * Book pages cannot be more than 14 lines with ~16 characters per line, 256
	 * characters max assume 2 lines for spell name, 1 blank line between name and
	 * flavor text, 1 blank link between flavor text and description text, means the
	 * first page has 9 lines of ~15 characters + continue, subsequent pages are 13
	 * lines of ~15 characters + continue.
	 *
	 * This means the first page for a spell can have ~175 characters and subsequent
	 * pages can be ~195.
	 *
