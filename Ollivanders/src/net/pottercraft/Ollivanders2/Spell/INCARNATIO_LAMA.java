 ...
 * @author Azami7
 */
public final class INCARNATIO_LAMA extends IncarnatioSuper
{
   /**
   ...
   public INCARNATIO_LAMA(Ollivanders2 plugin, Player player, Spells name, Double rightWand)
   {
      ...
      effect = new net.pottercraft.Ollivanders2.Effect.INCARNATIO_LAMA(player, Effects.INCARNATIO_LAMA, 1);
   }
}
