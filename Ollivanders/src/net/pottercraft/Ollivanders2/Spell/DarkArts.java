 ...
 * @author Azami7
 */
public abstract class DarkArts extends SpellProjectile implements O2Spell
{
    ...
    * @param rightWand
    */
   public DarkArts (Ollivanders2 plugin, Player player, Spells name, Double rightWand)
   {
