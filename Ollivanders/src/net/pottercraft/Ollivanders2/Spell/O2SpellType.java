...
public enum O2SpellType
{
   ...
   COLORO_ALBUM(net.pottercraft.Ollivanders2.Spell.COLORO_ALBUM.class),
   COLORO_AURANTIACO(net.pottercraft.Ollivanders2.Spell.COLORO_AURANTIACO.class),
   COLORO_CAERULUS(net.pottercraft.Ollivanders2.Spell.COLORO_CAERULUS.class),
   COLORO_FLAVO(net.pottercraft.Ollivanders2.Spell.COLORO_FLAVO.class),
   COLORO_OSTRUM(net.pottercraft.Ollivanders2.Spell.COLORO_OSTRUM.class),
   COLORO_VERIDI(net.pottercraft.Ollivanders2.Spell.COLORO_VERIDI.class),
   COLORO_VERMICULO(net.pottercraft.Ollivanders2.Spell.COLORO_VERMICULO.class),
