...
{
   ACONITE(Material.RED_ROSE, (short) 2, "Aconite", null), //allium
   ...
   DITTANY(Material.SAPLING, (short) 2, "Dittany", null), //birch sapling
   ...
   GALANTHUS_NIVALIS(Material.RED_ROSE, (short) 3, "Galanthus Nivalis", null), //azure bluet
   ...
   GROUND_PORCUPINE_QUILLS(Material.INK_SACK, (short) 3, "Ground Porcupine Quills", null),
   GROUND_SCARAB_BEETLE(Material.SULPHUR, (short) 0, "Ground Scarab Beetle", null),
   GROUND_SNAKE_FANGS(Material.INK_SACK, (short) 15, "Ground Snake Fangs", null),
   HONEYWATER(Material.POTION, (short) 0, "Honeywater", null),
   HORKLUMP_JUICE(Material.DRAGONS_BREATH, (short) 0, "Horklump Juice", null),
   ...
   KNOTGRASS(Material.LONG_GRASS, (short) 0, "Knotgrass", null),
   LACEWING_FLIES(Material.PUMPKIN_SEEDS, (short) 0, "Lacewing Flies", null),
   LAVENDER_SPRIG(Material.DOUBLE_PLANT, (short) 1, "Lavender Sprig", null), //lilac
   LEECHES(Material.INK_SACK, (short) 0, "Leeches", null),
   LETHE_RIVER_WATER(Material.POTION, (short) 0, "Lethe River Water", null), //bottle of water
   LIONFISH_SPINES(Material.RAW_FISH, (short) 0, "Lionfish Spines", null),
   MANDRAKE_LEAF(Material.WATER_LILY, (short) 0, "Mandrake Leaf", null),
   ...
   WOLFSBANE(Material.RED_ROSE, (short) 2, "Wolfsbane", null); // allium
   ;
