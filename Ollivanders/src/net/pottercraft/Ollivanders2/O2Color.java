...
public enum O2Color
{
   ...
   {
      int rand = Math.abs(Ollivanders2API.common.random.nextInt() % primaryDyeableColors.length);
   ...
   {
      int rand = Math.abs(Ollivanders2API.common.random.nextInt() % dyeableColors.length);
