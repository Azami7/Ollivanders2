...
public enum O2EffectType
{
   ...
   CONFUSION (net.pottercraft.Ollivanders2.Effect.CONFUSION.class),
   ...
   HARM (net.pottercraft.Ollivanders2.Effect.HARM.class),
   HEAL (net.pottercraft.Ollivanders2.Effect.HEAL.class),
   HEALTH_BOOST (net.pottercraft.Ollivanders2.Effect.HEALTH_BOOST.class),
   HUNGER (net.pottercraft.Ollivanders2.Effect.HUNGER.class),
   ...
   POISON (net.pottercraft.Ollivanders2.Effect.POISON.class),
   ...
   SLOW (net.pottercraft.Ollivanders2.Effect.SLOW.class),
   SUSPENSION (net.pottercraft.Ollivanders2.Effect.SUSPENSION.class),
   UNLUCK (net.pottercraft.Ollivanders2.Effect.UNLUCK.class),
   WEAKNESS (net.pottercraft.Ollivanders2.Effect.WEAKNESS.class),
