...
public class VERDIMILLIOUS_DUO extends SparksBase {
    ...
    public VERDIMILLIOUS_DUO(Ollivanders2 plugin) {
        ...
        text = "Shoots green sparks out of the caster's wand which can damage entities and can also reveal dark magic in items.";
    }
    ...
    public void doCheckEffect() {
        ...
        for (Item item : items) {
            ...
            // add to the cursed item list if it is cursed, also exclude things already glowing because we dont want to change their state
