...
/**
 * Transfiguration spell that disguises the target entity as a cow for a limited duration.
 */
public class BOVIFORS extends FriendlyMobDisguise {
     ...
     */
    public BOVIFORS(Ollivanders2 plugin) {
        super(plugin);

        spellType = O2SpellType.BOVIFORS;
        branch = O2MagicBranch.TRANSFIGURATION;

        minDuration = minDurationConfig;
        maxDuration = maxDurationConfig;

        text = "Turns target entity in to a cow.";
    }
     ...
     */
    public BOVIFORS(@NotNull Ollivanders2 plugin, @NotNull Player player, @NotNull Double rightWand) {
        ...
        if (!Ollivanders2.testMode) {
            ...
            CowWatcher watcher = (CowWatcher) disguise.getWatcher();
            watcher.setAdult();
        }
