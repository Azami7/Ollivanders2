...
/**
 * Jinx that transfigures the target player into a sheep for a limited duration.
 */
public class AGNIFORS_MAXIMA extends AddO2Effect {
    ...
    public AGNIFORS_MAXIMA(Ollivanders2 plugin) {
        ...
        text = "Jinx that changes the target player in to a sheep in appearance and behavior.";
    }
