...
/**
 * The Hardening Charm: transfigures blocks in a radius into stone, except hot blocks (lava, fire). Affected blocks
 * revert to their original material when the spell expires.
 *
 * @author Azami7
 * @see <a href="https://harrypotter.fandom.com/wiki/Hardening_Charm">Harry Potter Wiki - Hardening Charm</a>
 */
