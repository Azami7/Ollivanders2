...
/**
 * Transfiguration spell that disguises the target entity as a pig for a limited duration.
 */
public class SUIFORS extends FriendlyMobDisguise {
     ...
     */
    public SUIFORS(Ollivanders2 plugin) {
        super(plugin);

        spellType = O2SpellType.SUIFORS;
        branch = O2MagicBranch.TRANSFIGURATION;

        text = "Turns target entity in to a pig.";
    }
     ...
     */
    public SUIFORS(@NotNull Ollivanders2 plugin, @NotNull Player player, @NotNull Double rightWand) {
