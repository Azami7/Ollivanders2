...
/**
 * Jinx that transfigures the target player into a dog for a limited duration.
 */
public class CANIFORS_MAXIMA extends AddO2Effect {
    /**
     * Default constructor for use in generating spell text.  Do not use to cast the spell.
     *
     * @param plugin the Ollivanders2 plugin
     */
    public CANIFORS_MAXIMA(Ollivanders2 plugin) {
        super(plugin);
