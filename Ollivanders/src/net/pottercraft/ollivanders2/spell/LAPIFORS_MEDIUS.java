...
public final class LAPIFORS_MEDIUS extends FriendlyMobDisguise {
     ...
     */
    public LAPIFORS_MEDIUS(Ollivanders2 plugin) {
        super(plugin);

        spellType = O2SpellType.LAPIFORS_MEDIUS;
        branch = O2MagicBranch.TRANSFIGURATION;

        text = "Transfigures a small creature into a rabbit.";
    }
     ...
     */
    public LAPIFORS_MEDIUS(@NotNull Ollivanders2 plugin, @NotNull Player player, @NotNull Double rightWand) {
