...
/**
 * Cartomancy tarot divination — major-arcana tarot readings, with a maximum accuracy of 35% (more accurate than plain
 * {@link CARTOMANCY}).
 *
 * @author Azami7
...
public class CARTOMANCY_TAROT extends O2Divination {
    /**
     * Create a tarot cartomancy divination prophecy about the target.
     *
