...
/**
 * Cartomancy divination — playing-card readings drawn from the suit of spades, with a maximum accuracy of 25%.
 *
 * @author Azami7
...
public class CARTOMANCY extends O2Divination {
    /**
     * Create a cartomancy divination prophecy about the target.
     *
