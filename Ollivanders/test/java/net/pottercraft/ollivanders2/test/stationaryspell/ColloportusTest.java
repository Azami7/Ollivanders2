...
/**
 * Unit tests for {@link COLLOPORTUS}. Extends {@link O2StationarySpellTest} for the shared stationary-spell tests.
 *
 * @author Azami7
 */
public class ColloportusTest extends O2StationarySpellTest {
    ...
    /**
     * Place an acacia door at the location to act as the block the lock protects.
     *
     * @param testWorld the world to create the door in
     * @param location  where to create the door
    ...
    /**
     * Breaking a block inside the area is cancelled.
     */
    @Test
    ...
    /**
     * An entity breaking a door inside the area is cancelled.
     */
    @Test
    ...
    /**
     * An entity changing a block inside the area is cancelled.
     */
    @Test
    ...
    /**
     * An entity interacting with a block inside the area is cancelled.
     */
    @Test
    ...
    /**
     * A player interacting with a block inside the area has the interaction denied.
     */
    @Test
