...
/**
 * Unit tests for {@link net.pottercraft.ollivanders2.spell.GLACIUS_TRIA}. Extends {@link BlockTransfigurationTest} for
...
public class GlaciusTriaTest extends BlockTransfigurationTest {
    ...
    /**
     * Not applicable to GLACIUS_TRIA: its outputs (packed ice, ice, obsidian) are never valid targets, so it is never
